...
export const env = {
	...
	JWT_COOKIE_EXPIRES: getEnvVariable("JWT_COOKIE_EXPIRES"),
	JWT_REFRESH_EXPIRE: getEnvVariable("JWT_REFRESH_EXPIRE"),
	JWT_REFRESH_COOKIE_EXPIRE: getEnvVariable("JWT_REFRESH_COOKIE_EXPIRE"),
};
